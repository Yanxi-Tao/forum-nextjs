...
function useDraggableBlockMenu(editor, anchorElem, isEditable) {
  ...
  return createPortal(
    <>
      <div
        className="draggable-block-menu absolute top-0 left-0 cursor-grab active:cursor-grabbing"
        ref={menuRef}
        draggable={true}
      ...
      >
        ...
        {isEditable && <GripVertical className="h-4 w-4" />}
      </div>
      <div
        className="absolute top-0 left-0 bg-foreground h-1 "
        ref={targetLineRef}
      />
    </>,
    anchorElem
